...
def homepage():
    ...
    if loggedIn == True:
        return render_template('pages/homepage.html', coffeeList=list(formattedCoffeeList), loggedIn=1, user_id=loggedInUserId)
    else:
        return render_template('pages/homepage.html', coffeeList=list(formattedCoffeeList), loggedIn=0, user_id=loggedInUserId)
